...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping KEO International Consultants employees on creating new project proposals, and answering questions about existing project proposals. " \
...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching the project proposals submitted."
...
class EmployeeInfoTool(CsvLookupTool):
    ...
    def __init__(self, employee_name: str):
        super().__init__(filename = "data/employeeinfo.csv", key_field = "name", name = "Employee", description = "useful for answering questions about project proposals submitted")
